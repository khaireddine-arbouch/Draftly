    ...
    switch (shape.type) {
      ...
      case 'frame':
        ...
        if (shape.type === 'rect' || shape.type === 'frame') {
          ...
          ctx.quadraticCurveTo(relativeX + shape.w, relativeY, relativeX + shape.w, relativeY + borderRadius);
          ctx.lineTo(relativeX + shape.w, relativeY + shape.h - borderRadius);
          ctx.quadraticCurveTo(relativeX + shape.w, relativeY + shape.h, relativeX + shape.w - borderRadius, relativeY + shape.h);
          ctx.lineTo(relativeX + borderRadius, relativeY + shape.h);
          ctx.quadraticCurveTo(relativeX, relativeY + shape.h, relativeX, relativeY + shape.h - borderRadius);
          ctx.lineTo(relativeX, relativeY + borderRadius);
          ctx.quadraticCurveTo(relativeX, relativeY, relativeX + borderRadius, relativeY);
          ctx.closePath();
          ctx.stroke();
        } else if (shape.type === 'ellipse') {
          ctx.strokeStyle = shape.stroke && shape.stroke !== 'transparent' ? shape.stroke : '#000';
          ctx.lineWidth = shape.strokeWidth || 2;
