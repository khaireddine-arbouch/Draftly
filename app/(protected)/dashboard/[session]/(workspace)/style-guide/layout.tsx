...
import { Hash, Type, LayoutIcon } from "lucide-react"; // Adjust to your actual import source
...
] as const; // This ensures the array is treated as a readonly tuple with fixed types
