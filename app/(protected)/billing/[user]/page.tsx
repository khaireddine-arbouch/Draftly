                ...
                <div className="bg-primary/10 border border-primary/20 rounded-lg p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-xs">
                        Each credit equals one AI task. Use them for code
                        generation, asset exports, or any premium feature.
                        Credits refresh monthly, so you always have what you
                        need.
                      </p>
                    </div>
                  </div>
